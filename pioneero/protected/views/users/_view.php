...
<div class="view">
	...
	<?php /*
	<b><?php echo CHtml::encode($data->getAttributeLabel('mail_check')); ?>:</b>
	<?php echo CHtml::encode($data->mail_check); ?>
	<br />
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('email_check_date')); ?>:</b>
	<?php echo CHtml::encode($data->email_check_date); ?>
	<br />
